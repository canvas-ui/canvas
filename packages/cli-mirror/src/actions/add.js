...
export default {
    ...
    flags: { hub: 'string', root: 'string', pin: 'string', ignore: 'string', conflicts: 'string', deletes: 'string', direction: 'string', client: 'string', 'cache-budget-mb': 'string', service: 'boolean', 'no-start': 'boolean' },
