...
export function configurePublishedMirror({ remoteId, ws, folder, root, conflicts, deletes, direction = 'bi', stateDir = null, managed, ignore = [] }) {
    ...
    return upsertMirror(buildMirror({
        ...
        client: 'daemon', conflicts, deletes, direction, stateDir, managed, ignore,
    }));
}
