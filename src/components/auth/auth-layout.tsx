    ...
    <div className="flex min-h-viewport w-full items-center justify-center p-4 flex-col">
      <Card className="flex w-[95vw] h-viewport-modal overflow-hidden">
        {/* The particle panel is dark by design in every theme — the logo is a
            ...
            hardcoded black-and-white: content tokens resolve to the active
            theme's dark values, so it stays on-palette in Nord or Terminal and
            goes true-black under High Contrast. */}
        <div className="hidden md:block w-1/2 relative bg-background" data-scheme="dark" id="particle-js">
          <Link className="absolute top-8 left-8 font-bold text-foreground flex items-center z-raised" to="/">
            <img
          ...
          <div className="absolute bottom-8 left-8 text-sm text-foreground max-w-[80%] z-raised">
        ...
        <div className="flex w-full md:w-1/2 flex-col justify-center px-4 py-12 sm:px-6 lg:px-8">
          <div className="mx-auto w-full max-w-sm">
            ...
            <div className="mt-8 border-t pt-6">
              <a href="https://github.com/canvas-ui" target="_blank" className="text-muted-foreground hover:text-foreground justify-center flex items-center space-x-2" rel="noopener noreferrer">
              ...
              <SourceLink className="mt-4 text-center" />
            </div>
          </div>
        </div>
      </Card>
