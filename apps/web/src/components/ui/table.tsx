...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      // Tighter gutters below md: four columns of `px-4` spent 128px of a
      // 360px phone on padding alone, squeezing the title column to a few
      // characters. Desktop keeps the roomy rhythm.
