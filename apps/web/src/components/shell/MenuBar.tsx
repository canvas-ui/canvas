    ...
    <TooltipProvider delayDuration={200}>
      ...
      <div
        className={cn(
          ...
          state.m0Open
            ? 'max-md:fixed max-md:left-2 max-md:top-2 max-md:bottom-rail-stack max-md:z-rail max-md:h-auto max-md:rounded-[var(--panel-radius)] max-md:bg-card max-md:surface-glass max-md:shadow-elevation-5 max-md:animate-fade-in'
            : 'max-md:hidden',
        )}
      >
        {/* Logo */}
